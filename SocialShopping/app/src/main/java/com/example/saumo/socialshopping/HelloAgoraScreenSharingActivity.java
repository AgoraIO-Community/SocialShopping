...
public class HelloAgoraScreenSharingActivity extends AppCompatActivity {
    ...
    public void onLiveSharingScreenClicked(View view) {
        ...
        if (button.isSelected()) {
            ...
            Intent intent = new Intent(HelloAgoraScreenSharingActivity.this, HomeActivity.class);
